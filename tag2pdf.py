...
for i in range(1, len(reader.pages)):
    ...
    cb = p1.cropbox
    p1.mediabox = RectangleObject((cb.left+x_n*length, cb.bottomy_n*height,
                                   cb.right+x_n*length, cb.topy_n*height))
    p1.cropbox = RectangleObject((cb.left+x_n*length, cb.bottomy_n*height,
                                   cb.right+x_n*length, cb.topy_n*height))
    p1.trimbox = RectangleObject((cb.left+x_n*length, cb.bottomy_n*height,
                                   cb.right+x_n*length, cb.topy_n*height))
    p1.bleedbox = RectangleObject((cb.left+x_n*length, cb.bottomy_n*height,
                                   cb.right+x_n*length, cb.topy_n*height))
    p1.artbox = RectangleObject((cb.left+x_n*length, cb.bottomy_n*height,
                                   cb.right+x_n*length, cb.topy_n*height))
